...
function locale_default2(locale5) {
  var group2 = locale5.grouping === void 0 || locale5.thousands === void 0 ? identity_default5 : formatGroup_default2(map4.call(locale5.grouping, Number), locale5.thousands + ""), currencyPrefix = locale5.currency === void 0 ? "" : locale5.currency[0] + "", currencySuffix = locale5.currency === void 0 ? "" : locale5.currency[1] + "", decimal = locale5.decimal === void 0 ? "." : locale5.decimal + "", numerals = locale5.numerals === void 0 ? identity_default5 : formatNumerals_default2(map4.call(locale5.numerals, String)), percent = locale5.percent === void 0 ? "%" : locale5.percent + "", minus = locale5.minus === void 0 ? "-" : locale5.minus + "", nan = locale5.nan === void 0 ? "NaN" : locale5.nan + "";
  function newFormat(specifier) {
...
function ticker(year2, month2, week, day2, hour2, minute2) {
  ...
  function tickInterval(start2, stop, count3) {
    ...
    if (i === tickIntervals.length) return year2.every(tickStep(start2 / durationYear, stop / durationYear, count3));
...
function calendar(ticks2, tickInterval, year2, month2, week, day2, hour2, minute2, second4, format3) {
  ...
  scale2.copy = function() {
    return copy(scale2, calendar(ticks2, tickInterval, year2, month2, week, day2, hour2, minute2, second4, format3));
  };
  return scale2;
}
function time() {
...
function transformer3() {
  var x06 = 0, x12 = 1, t05, t15, k10, transform2, interpolator = identity3, clamp = false, unknown;
  function scale2(x4) {
...
function transformer4() {
  var x06 = 0, x12 = 0.5, x22 = 1, s2 = 1, t05, t15, t22, k10, k21, interpolator = identity3, transform2, clamp = false, unknown;
  function scale2(x4) {
...
function arc_default() {
  ...
  function arc() {
    ...
    if (!(r1 > epsilon8)) context.moveTo(0, 0);
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da2, da1 = da2, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon8 && (padRadius ? +padRadius.apply(this, arguments) : sqrt3(r0 * r0 + r1 * r1)), rc = min3(abs4(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t05, t15;
      if (rp > epsilon8) {
...
function pie_default() {
  var value = identity_default6, sortValues = descending_default, sort2 = null, startAngle = constant_default10(0), endAngle = constant_default10(tau6), padAngle = constant_default10(0);
  function pie(data) {
...
function timeInterval2(floori, offseti, count3, field) {
  function interval2(date2) {
    return floori(date2 = arguments.length === 0 ? /* @__PURE__ */ new Date() : /* @__PURE__ */ new Date(+date2)), date2;
  }
  interval2.floor = (date2) => {
...
function ticker2(year2, month2, week, day2, hour2, minute2) {
  ...
  function tickInterval(start2, stop, count3) {
    const target = Math.abs(stop - start2) / count3;
    const i = bisector(([, , step2]) => step2).right(tickIntervals, target);
    if (i === tickIntervals.length) return year2.every(tickStep(start2 / durationYear2, stop / durationYear2, count3));
    if (i === 0) return millisecond3.every(Math.max(tickStep(start2, stop, count3), 1));
    const [t, step] = tickIntervals[target / tickIntervals[i - 1][2] < tickIntervals[i][2] / target ? i - 1 : i];
    return t.every(step);
  }
  return [ticks2, tickInterval];
...
function zoom_default2() {
  ...
  zoom.scaleTo = function(selection2, k2, p, event) {
    zoom.transform(selection2, function() {
      var e = extent2.apply(this, arguments), t05 = this.__zoom, p02 = p == null ? centroid(e) : typeof p === "function" ? p.apply(this, arguments) : p, p1 = t05.invert(p02), k1 = typeof k2 === "function" ? k2.apply(this, arguments) : k2;
  ...
  function dblclicked(event, ...args) {
    if (!filter3.apply(this, arguments)) return;
    var t05 = this.__zoom, p02 = pointer_default(event.changedTouches ? event.changedTouches[0] : event, this), p1 = t05.invert(p02), k1 = t05.k * (event.shiftKey ? 0.5 : 2), t15 = constrain(translate(scale2(t05, k1), p02, p1), extent2.apply(this, args), translateExtent);
    noevent_default3(event);
