...
export default function GeographicBoundariesDemo() {
  const { dhc } = useParams();
  ...
  // Get radius from URL params or default to 10
  ...
  const handleBoundaryClick = (feature, event) => {
    ...
    // Create popup with boundary information
    ...
    <div className={styles.container}>
      <Banner>
        <div className={styles.bannerContent}>
          ...
          <div>
            <h2>Geographic Boundaries Demo</h2>
            ...
            <div className={styles.boundaryTypeSelector}>
              ...
              <div className={styles.buttonGroup}>
                {boundaryTypes.map(type => (
                  <Button
                    key={type.value}
                    variant={selectedBoundaryType === type.value ? 'teal' : 'gray'}
                    size="sm"
      ...
      <div className={styles.mapSection}>
        <GeographicBoundaryMap
          centerPoint={{ latitude: provider.latitude, longitude: provider.longitude }}
