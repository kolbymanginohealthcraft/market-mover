...
import TaxonomiesTagsView from './TaxonomiesTagsView';
import TaxonomiesBrowseView from './TaxonomiesBrowseView';
...
export default function TaxonomiesLayout() {
    ...
    return (
      <div className={styles.container}>
        <div className={styles.teamRequiredState}>
          ...
          <h3>Team Required</h3>
          <p>Join or create a team to access taxonomy tagging features.</p>
          <p>These features help you collaborate with your team and manage taxonomy relationships.</p>
  ...
  return (
    <div className={styles.container}>
      <Routes>
        <Route path="tags" element={<TaxonomiesTagsView />} />
        <Route path="browse" element={<TaxonomiesBrowseView />} />
